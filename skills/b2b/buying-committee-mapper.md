...
> Can this be completed in a single 10-minute Claude session? **Yes.** Input is account context + known contacts. Output is a Markdown committee map. No system access needed.
